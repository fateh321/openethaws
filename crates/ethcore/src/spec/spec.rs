        ...
        // basic accounts in spec.
        {
            ...
            for (address, account) in self.genesis_state.get().iter() {
                if AggProof::get_genesis_commit() == 0u64 {
                    ...
                    AggProof::pushAddressDelta(address.to_low_u64_be().rem_euclid(2u64.pow(AggProof::hyperproof_bits())),account.balance().to_string(),address.to_low_u64_be().rem_euclid(AggProof::shard_count()));
